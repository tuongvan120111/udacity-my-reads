...
This is final assessment project for Udacity's React Fundamentals course. The goal of this project that is how to use reactjs in reality by providing a dynamic website which code by CSS and HTML and JSX, and apply some SOLID architecture to reduce effort for coding.
